...
int main(int argc, char* arv[]) {
	...
	cout << "Connecting to stepping stone: " << firstStone.first << " on port: "
			<< firstStone.second << endl;
	cconnect(firstStone.second, const_cast<char *>(firstStone.first.c_str()),
			const_cast<char *>(a.first), s);
